...
//game_event routers
    ...
    //retrieve game_event
    router.get('/api/get-game_event/:game_id', game_event.get_game_event);
    //update game_event
    router.post('/api/update-account', game_event.update_game_event);
    //delete game_event
    router.post('/api/delete-game_event/:game_id', game_event.delete_game_event);
...
//game_event_sponsor routers
    ...
    router.get('/api/get-game_event_sponsor/:game_id/:sponsor_id', game_event_sponsor.get_game_event_sponsor);
    //update game_event_sponsor
    router.post('/api/update-game_event_sponsor/:game_id/:sponsor_id', game_event_sponsor.update_game_event_sponsor);
    //delete game_event_sponsor
    router.post('/api/delete-game_event_sponsor/:game_id/:sponsor_id', game_event_sponsor.delete_game_event_sponsor);

//log routers
    //create log
    router.post('/api/add-log', log.add_log);
    //retrieve log
    router.get('/api/get-log/:log_id', log.get_log);
    //update log
...
//match_event routers
    ...
    router.get('/api/get-match_event/:match_id', match_event.get_match_event);
    //update match_event
    router.post('/api/update-match_event', match_event.update_match_event);
    //delete match_event
    router.post('/api/delete-match_event/:match_id', match_event.delete_match_event);

...
//game_event routers
   ...
   router.get('/api/get-participants/:game_id', game_event.get_participants);
   //update game_event
   ...
   router.get('/api/get-user-ongoing-events/:account_id?', game_event.get_user_ongoing_events);
   ...
   router.get('/api/get-past-events/', game_event.get_past_events);
...
//match_event routers
   ...
   router.post('/api/update-match-court', match_event.update_match_event);

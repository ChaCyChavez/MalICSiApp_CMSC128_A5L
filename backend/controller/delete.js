...
exports.delete_team_player = (req, res, next) => {
	const query_string ='DELETE FROM team_player WHERE player_id = ? and player_id = ?'; 
...
exports.delete_sport_player = (req, res, next) => {
	const query_string ='DELETE FROM game_player WHERE sport_id = ? and player_id = ?'; 
...
exports.delete_game_player = (req, res, next) => {
	const query_string ='DELETE FROM game_player WHERE game_id = ? and player_id = ?'; 
...
exports.delete_game_sponsor = (req, res, next) => {
	const query_string ='DELETE FROM game_sponsor WHERE game_id = ? and sponsor_id = ?'; 
...
exports.delete_participates = (req, res, next) => {
	const query_string ='DELETE FROM participates WHERE player_id = ? and sport_id = ?'; 
...
exports.delete_registers = (req, res, next) => {
	const query_string ='DELETE FROM registers WHERE player_id = ? and game_id = ?'; 
...
exports.delete_game_game_type = (req, res, next) => {
	const query_string ='DELETE FROM game_game_type WHERE game_id = ? and game_type = ?'; 
